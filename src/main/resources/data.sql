-- 애플리케이션 시작 시 자동으로 실행될 초기 데이터입니다.
INSERT INTO activity_types (id, type_code, description) VALUES
...
(9, 'PROFILE_UPDATED', '프로필 수정')
    ON DUPLICATE KEY UPDATE type_code=VALUES(type_code), description=VALUES(description);
